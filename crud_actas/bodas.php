...
<html lang="en">
    <head>
        <title> PAGINA ACTA DE NACIMIENTO</title>
        <meta charset="UTF-8">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizar.php?id=<?php echo $row['idActa'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete.php?id=<?php echo $row['idActa'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
